{if $newUser}
    {assign var="buttonLabel" value="ADD PERSONAL CARE WORKER"}
{else}
    {assign var="buttonLabel" value="UPDATE PERSONAL CARE WORKER"}
{/if}
        ...
        <div class="content-area">
            <div class="navbar navbar-admin">
                <div class="left-align-b buttons-wrap">
                    <input onclick="location.href='{$URL}personalCareWorkers';" type="button" class="button-global smallb hollow" name="button_click" value="&larr; RETURN TO PERSONAL CARE WORKERS" />
                </div>
            </div>
            <div class="section-wrap nopadding">
                <form accept-charset="UTF-8" id="js__personal-care-worker-add" class="form-admin" data-src="{$URL}personalCareWorkers/createUpdateUser" enctype="multipart/form-data" method="post">
                    <div class="optional-wrap">
                        <div class="section-input">
                            <div class="field-set">
                                <div class="form-label-wrap"><span class="label">First Name <span>*</span></span></div>
                                <input type="text" name="firstName" maxlength="64" value="" class="input short" autocomplete='given-name' />
                            </div>
                            <div class="field-set">
                                <div class="form-label-wrap"><span class="label">Last Name</span></div>
                                <input type="text" name="lastName" maxlength="64" value="" class="input short" autocomplete='family-name' />
                            </div>
                            <div class="field-set">
                                <div class="form-label-wrap"><span class="label">E-mail Address <span>*</span></span></div>
                                <input type="text" name="emailAddress" maxlength="64" value="" class="input short" autocomplete='' />
                            </div>
                            <div class="field-set">
                            ...
                            <div class="field-set">
                                ...
                                <input type="text" name="street" maxlength="64" value="" class="input short" autocomplete='' />
                            </div>
                            <div class="field-set">
                                <div class="form-label-wrap"><span class="label">City <span>*</span></span></div>
                                <input type="text" name="city" maxlength="64" value="" class="input short" autocomplete='' />
                            </div>
                            <div class="field-set">
                            ...
                            <div class="field-set">
                                ...
                                <input type="text" name="postalCode" maxlength="64" value="" class="input short" autocomplete='' />
                            </div>
                            <div class="field-set">
                                <div class="form-label-wrap"><span class="label">Phone Number <span>*</span></span></div>
                                <input type="text" name="phoneNumber" maxlength="64" value="" class="input short" autocomplete='' />
                            </div>
                            <div class="field-set">
                                <div class="form-label-wrap"><span class="label">Additional Phone Number </span></div>
                                <input type="text" name="additionalPhoneNumber" maxlength="64" value="" class="input short" autocomplete='' />
                            </div>
                            <div class="field-set">
                                <div class="form-label-wrap"><span class="label">Alternate Contact Name </span></div>
                                <input type="text" name="alternateContactName" maxlength="64" value="" class="input short" autocomplete='' />
                            </div>
                        </div>
                    </div>
