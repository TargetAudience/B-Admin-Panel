{if $newUser} {assign var="buttonLabel" value="ADD CAREGIVER"} {else} {assign var="buttonLabel" value="UPDATE CAREGIVER"} {/if}
        ...
        <div class="content-area">
            <div class="navbar navbar-admin">
                <div class="left-align-b buttons-wrap">
                    <input onclick="location.href='{$URL}caregivers';"
                        type="button"
                        class="button-global smallb hollow"
                        name="button_click"
                        value="← RETURN TO CAREGIVERS">
                </div>
            </div>
            <div class="section-wrap">
                <div class="left-align-b buttons-wrap">
                    <button onclick="location.href='{$URL}caregivers/editUser?id={$userIdEncoded}'" type="button" class="button-global smallb">EDIT CAREGIVER</button>
                </div>
