        ...
        <div class="content-area">
            <div class="navbar navbar-admin">
                <div class="left-align-b buttons-wrap">
                    <button onclick="location.href='{$URL}users/addUser'" type="button" class="button-global smallb">ADD USER</button>
                </div>
            </div>
                    ...
                    <tbody>
                        {foreach from=$userData item=user}
                            <tr>
                                ...
                                <td>{$user.primaryCarePerson}</td>
                                <td>{$user.createOn}</td>
                                <td><a href="{$URL}users/userProfile?id={$user.userIdEncoded}" class="view-link">View</a> <a href="#" data-src="{$URL}administration/remove?type=users&id={$user.userIdEncoded}" class="js__admin-remove-item icon-spacer"><span class="icon-trash"></span></a></td>
                            </tr>
                        {/foreach}
                    </tbody>
                </table>
