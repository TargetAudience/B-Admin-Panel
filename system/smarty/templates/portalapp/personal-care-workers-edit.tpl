    ...
    <div id="page-content-wrapper" class="container-fluid">
        <div class="content-area">
            ...
            <div class="section-wrap nopadding">
                <form accept-charset="UTF-8" id="js__personal-care-worker-edit" class="form-admin" data-src="{$URL}personalCareWorkers/createUpdateUser" enctype="multipart/form-data" method="post">
                    <input type="hidden" name="userId" id="js__personal-care-worker-edit-userid" value="{$userIdEncoded}" />
