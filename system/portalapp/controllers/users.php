...
class Users_Controller extends App_Controller
{
    ...
    public function index()
    {
        ...
        $userDataCount = $this->administration->get_users_registered_all();
        $pagination = $this->getPagination($per_page, $page_number, $userDataCount['count']);
        $userData = $this->administration->get_users_registered($pagination);

        foreach ($userData as &$user) {
            $user['userType'] = $page;
            $user['createOn'] = date('M j, Y', strtotime($user['createOn']));
            $user['lastVisitOn'] = date('M j, Y', strtotime($user['updatedOn']));
            $user['primaryCarePerson'] = $user['accountHolder'] == 1 ? 'Yes' : 'No';
        ...
        $this->smarty->display(portalapp_THEME . '/users.tpl');
    ...
    public function usersPurchases()
    {
        ...
        $userData = $this->administration->get_all_user_purchases($userId);
        ...
        $this->smarty->assign('page_nums', $pagination);
        $this->smarty->assign('currentPage', 'users');
        $this->smarty->assign('subPage', 'userPosts');
        $this->smarty->assign('pageTitle', 'User Purchases');
        $this->smarty->assign('session', $_SESSION);
        $this->smarty->display(portalapp_THEME . '/page_meta.tpl');
        $this->smarty->display(portalapp_THEME . '/page_header_inside.tpl');
        $this->smarty->display(portalapp_THEME . '/administration-user-view-purchases.tpl');
        $this->smarty->display(portalapp_THEME . '/page_footer_inside.tpl');
        $this->smarty->display(portalapp_THEME . '/page_footer_meta.tpl');
    }
    ...
    public function details()
    {
        ...
        $this->smarty->assign('userIdEncoded', Crypt::enc_encrypt($userData['userId']));
        $this->smarty->assign('purchaseIdEncoded', $id);
        $this->smarty->assign('successMessage', $successMessage);
        $this->smarty->assign('newUser', false);

        $this->smarty->assign('currentPage', 'users');
        $this->smarty->assign('subPage', '');
        $this->smarty->assign('pageTitle', 'User Purchases - Details');
        $this->smarty->assign('subPageJS', '');
        $this->smarty->assign('session', $_SESSION);
        $this->smarty->display(portalapp_THEME . '/page_meta.tpl');
        $this->smarty->display(portalapp_THEME . '/page_header_inside.tpl');
        $this->smarty->display(portalapp_THEME . '/administration-user-view-purchases-details.tpl');
    ...
    public function addUser()
    {
        ...
        $this->smarty->display(portalapp_THEME . '/page_meta.tpl');
        $this->smarty->display(portalapp_THEME . '/page_header_inside.tpl');
        $this->smarty->display(portalapp_THEME . '/administration-user-add.tpl');
        $this->smarty->display(portalapp_THEME . '/page_footer_inside.tpl');
    }
    ...
    public function insertUser()
    {
        ...
        $userId = $this->administration->create_user($uuid, $first_name, $last_name, $email, $primaryCarePerson, $street, $city, $province, $postalCode, $phoneNumber, $additionalPhoneNumber, $alternateContactName, $password);
    ...
    public function editUser()
    {
        ...
        $this->smarty->assign('pageTitle', 'Edit User');
    ...
    public function userProfile()
    {
        ...
        $this->smarty->assign('pageTitle', 'User Profile | ' . $userData['firstName']);
        $this->smarty->assign('subPageJS', '');
        $this->smarty->assign('session', $_SESSION);
        $this->smarty->display(portalapp_THEME . '/page_meta.tpl');
        $this->smarty->display(portalapp_THEME . '/page_header_inside.tpl');
        $this->smarty->display(portalapp_THEME . '/administration-user-view.tpl');
        $this->smarty->display(portalapp_THEME . '/page_footer.tpl');
    }
    ...
    public function createUpdateUser()
    {
        ...
        if ($userId == null) {
            $uuid = utilities::createUUID;
            $userId = $this->administration->create_user($uuid, $first_name, $last_name, $email, $primaryCarePerson, $street, $city, $province, $postalCode, $phoneNumber, $additionalPhoneNumber, $alternateContactName);
    ...
    public function sendInternalMessage()
    {
        ...
        $user = $this->administration->get_user($_SESSION['organizationId'], $userId);

        $redirect = 'users/index/tx';
