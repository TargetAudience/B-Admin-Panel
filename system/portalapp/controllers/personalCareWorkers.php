...
class PersonalCareWorkers_Controller extends App_Controller
{
    public function index()
    {
        ...
        $userDataCount = $this->administration->get_users_registered_personal_care_workers_all();
        $pagination = $this->getPagination($per_page, $page_number, $userDataCount['count']);
        $userData = $this->administration->get_users_registered_personal_care_workers($pagination);
        ...
        $this->smarty->assign('currentPage', 'personalCareWorkers');
        $this->smarty->assign('subPage', '');
        $this->smarty->assign('pageTitle', 'Personal Care Workers');
        $this->smarty->assign('session', $_SESSION);
        $this->smarty->display(portalapp_THEME . '/page_meta.tpl');
        $this->smarty->display(portalapp_THEME . '/page_header_inside.tpl');
        $this->smarty->display(portalapp_THEME . '/personal-care-workers.tpl');
    ...
    public function userProfile()
    {
        ...
        $this->smarty->assign('pageTitle', 'Personal Care Workers | ' . $userData['firstName']);
        $this->smarty->assign('subPageJS', '');
        $this->smarty->assign('session', $_SESSION);
        $this->smarty->display(portalapp_THEME . '/page_meta.tpl');
        $this->smarty->display(portalapp_THEME . '/page_header_inside.tpl');
        $this->smarty->display(portalapp_THEME . '/personal-care-workers-view.tpl');
    ...
    public function addUser()
    {
        ...
        $this->smarty->display(portalapp_THEME . '/page_meta.tpl');
        $this->smarty->display(portalapp_THEME . '/page_header_inside.tpl');
        $this->smarty->display(portalapp_THEME . '/personal-care-workers-add.tpl');
        $this->smarty->display(portalapp_THEME . '/page_footer_inside.tpl');
    }
    ...
    public function editUser()
    {
        ...
        $this->smarty->display(portalapp_THEME . '/page_header_inside.tpl');
        if (count($userData) > 1):
            $this->smarty->display(portalapp_THEME . '/personal-care-workers-edit.tpl');
        endif;
        $this->smarty->display(portalapp_THEME . '/page_footer_inside.tpl');
    }
    ...
    public function createUpdateUser()
    {
        ...
        if ($userId == null) {
            ...
            $userId = $this->administration->create_personalCareWorker($first_name, $last_name, $email, $primaryCarePerson, $street, $city, $province, $postalCode, $phoneNumber, $additionalPhoneNumber, $alternateContactName);
